...
export async function seed(knex) {
  ...
  await knex('users').insert([
    ...
    // HQ_SUPER_ADMIN — HQ
    {
      ...
      contact_no:    '2UEqhRRW1BjSS7nd:fyradMQwyhVN615mRef6Kw==:0zMj3uJDJCOL7wkp',
    ...
    // HQ_OFFICER — HQ
    {
      ...
      contact_no:    'okCluOikrv+BJgCf:TFE6JvjDdWrUefneZ4ODsA==:BipVIlJ2RkwVSsuH',
      office_id:     '44444444-0001-0001-0001-000000000001',
    ...
    // PROVINCIAL_HEAD — WP PHQ
    {
      ...
      contact_no:    'ZKU6gQnfVUaYbroY:V92zzjMjzrf0FKvCluavUg==:RrJMNiMpBGFQgjzM',
    ...
    // PROVINCIAL_OFFICER — WP PHQ
    {
      ...
      contact_no:    '0f1b4pOHsrYQ0RCt:d4pKlIDExggGZEmwknNQBg==:+wlnZSAhJW4bSBj3',
      office_id:     '44444444-0002-0002-0002-000000000002',
    ...
    // PROVINCIAL_HEAD — CP PHQ
    {
      ...
      contact_no:    '0t89ZCB8//lGX9z4:YPeed9Jjl06qsZX4e57LoA==:mwGn8b0qRd1B33HU',
    ...
    // PROVINCIAL_OFFICER — SP PHQ
    {
      ...
      contact_no:    'bwX4fHehyWOCt6vZ:CUJ3iR+wbpbopi7yeD+/+Q==:jZMDDKAmQwYKmCTh',
    ...
    // STATION_HEAD — Colombo Fort
    {
      ...
      contact_no:    'xO0uh+if/+mYJ2Nd:H/fJR5qTWiUqTqp4Af4YXw==:3emXogtK1RcD98hT',
    ...
    // STATION_OFFICER — Colombo Fort
    {
      ...
      contact_no:    '/D2txqRiSvsiQuz8:QSUIlXsieW9WMAG3JKu2Gg==:i6bxk81Fr8j/a2Fu',
      office_id:     '44444444-0011-0011-0011-000000000011',
    ...
    // STATION_HEAD — Negombo
    {
      ...
      contact_no:    'zs2MvP7/9m8qK2qR:CSh0i5+pqGJ4txWdM2nRpg==:M3mZlRPOOp5Mhjb7',
    ...
    // STATION_OFFICER — Kandy City
    {
      ...
      contact_no:    'w0JATrGxEerAGIoZ:0/U/xiqlH6M0qpWvBI68JQ==:KbrSxCsYdd91xxDB',
    ...
    // STATION_HEAD — Jaffna City
    {
      ...
      contact_no:    '+F6NY/bE/bCVehVL:PwphmHxlZUVdkuscALsg7g==:Fyct+eoTjyVTz2bT',
    ...
    // STATION_OFFICER — Galle City
    {
      ...
      contact_no:    '5gdB0l9A0SP5thLN:fSK/dM6UQ+cQpvbTsUm3rQ==:JAAm97rXZTwprJwT',
